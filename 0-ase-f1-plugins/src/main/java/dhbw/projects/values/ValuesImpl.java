...
public class ValuesImpl implements ValuesRepository {
    ...
    public void setDrivers() {
        ...
        String[] driverNations = {"Netherlands", "Great Britain", "Finland", "Spain", "Germany", "Monaco",
                "Great Britain", "Spain", "Australia", "France", "France","Japan","Mexico","Canada","Finland","Italy",
                "Russia","Germany","Great Britain","Canada"};
        String[] driverTeams = {"Red Bull Racing", "Mercedes-AMG Petronas", "Mercedes-AMG Petronas", "Alpine",
                "Aston Martin", "Ferrari", "McLaren", "Ferrari", "McLaren", "Alpine", "AlphaTauri", "AlphaTauri",
                "Red Bull Racing", "Aston Martin", "Alfa Romeo Racing", "Alfa Romeo Racing", "Haas","Haas","Williams",
                "Williams"};
